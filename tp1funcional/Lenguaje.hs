...
foldExp fC fV fB fI fL fCa (Let v e1 e2)     = fL v (foldExp fC fV fB fI fL fCa e1) (foldExp fC fV fB fI fL fCa e2)
--foldExp fC fV fB fI fL fCa (Let v e1 e2)     =  foldExp fC fV.f fB fI fL fCa e2
--						where f = fL v (foldExp fC fV fB fI fL fCa e1)
foldExp fC fV fB fI fL fCa (Call f e1)       = fCa f (map (foldExp fC fV fB fI fL fCa) e1)
